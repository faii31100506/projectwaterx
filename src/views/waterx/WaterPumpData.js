...
const WaterPumpData = () => {
  ...
  const MoreInfo = () => {
    return (
      <button className="info-button" onClick={() => setPumppage("2")}>
        ข้อมูลเพิ่มเติม
      </button>
    );
  };
    ...
    content = (
      <>
        <div className="d-flex justify-content-between mt-4 ms-4">
          ...
          <button className="wblue-button " onClick={() => setPumppage("1")}>
            + เพิ่มข้อมูลเครื่องปั้มน้ำ
          </button>
        </div>
        <DataTable
          value={data}
          header="รายการเครื่องปั้มน้ำ"
          paginator
          rows={8}
      ...
      <>
        ...
        <div className="customcontainer5 mt-4">
          ...
          <div className="d-flex flex-column">
            ...
            <div className="d-flex mt-5">
              ...
              <div className="w-25">
                <CForm className="w-60">
                  <CFormInput
                    className="w-90"
                    label="ระยะดูดต่ำสุด-สูงสุด (เมตร)"
                  />
                </CForm>
              </div>
              <div className="w-25">
                <CForm className="w-60">
                  <CFormInput
                    className="w-90"
                    label="แรงดันน้ำต่ำสุด-สูงสุด (บาร์)"
                  />
                </CForm>
              </div>
              <div className="w-25">
                <CForm className="w-60">
                  <CFormInput
                    className="w-90"
                    label="ปริมาณน้ำสูงสุด (ลิตร/นาที)"
                  />
                </CForm>
              </div>
            </div>
            ...
            <button className="wblue-button-unrounded mt-auto mb-5 w-15 text-center">
              บันทึกข้อมูล
            </button>
          </div>
        </div>
    ...
    content = (
      <>
        <div className="d-flex flex-column mt-4 ms-4">
          ...
          <div className="mapcontainer h-60"></div>
          <div className="customcontainer5 flex-column d-flex">
            ...
            <div className="d-flex mx-5 mb-5">
              <div className="customcontainer4 w-30 mb-5 h-49">
                <h4 className="text-center mt-5">ประวัติการเปลี่ยนปั้มน้ำ</h4>
              </div>

              <div className="customcontainer4 mx-5 w-70 mb-5 d-flex flex-column">
                <h4 className="text-center mt-5">สเปกเครื่องปั้มน้ำ</h4>
