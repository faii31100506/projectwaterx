        ...
        content = (
            <>
                ...
                <div className="d-flex justify-content-between mt-4 ms-4">
                    ...
                    <button className="wblue-button me-5" onClick={() => setMeterFtpage(1)}>+ จดมิเตอร์ค่าน้ำ</button>


                </div>
                <div className="mt-5">

                    <DataTable value={data} header="ตารางรายการจดมิเตอร์ค่าน้ำ" filters={filters}
                        paginator
                        rows={8}
        ...
        content = (
            <>
                <div className="d-flex mt-4">
                    <img className="mt-1" src={require("../../assets/images/backbutton.png")} width={30} height={30} onClick={() => setMeterFtpage(0)} />
                    ...
                    <div className="d-flex flex-column">
                        <div className="d-flex mt-5 mb-3 ms-5">
                            ...
                            <div className="d-flex flex-column w-20">
                                <div className="break-word mt-1">ชื่อนามสกุล : นายทำดี สีสะอาด</div>
                                <div className="break-word mt-1">เลขที่ประจำมาตรวัดน้ำ : 0-112734-56</div>
                                <div className="break-word mt-1">ที่ติดตั้งมาตร: บ้านเลขที่ 56/1 หมู่ 3 ต.จรเข้เผือก อ.ด่านมะขามเตี้ย จ.กาญจนบุรี</div>
                        ...
                        <div className="d-flex mt-5 ms-5">
                            ...
                            <div className="d-flex">
                                <CForm className="me-4">
                                    <CFormInput
                                    label="จดเลขครั้งก่อน" disabled defaultValue={1893790}/>
                                </CForm>
                            ...
                            <button className="wblue-button-unrounded-nocenter mt-5 w-40 mb-5 text-center">บันทึกข้อมูล</button>
                            </div>
                        </div>
