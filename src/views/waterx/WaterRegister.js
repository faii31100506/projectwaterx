  ...
  if (registerpage === 2){
    content = (
      ...
      <h2 className="mx-3">เพิ่มทะเบียนผู้ใช้น้ำ</h2>
          <button onClick={() =>setRegisterpage(2)}>1</button>
          <button onClick={() =>setRegisterpage(3)}>2</button>
          <button onClick={() =>setRegisterpage(4)}>3</button>
          <button onClick={() =>setRegisterpage(5)}>4</button>
          <button onClick={() =>setRegisterpage(6)}>5</button>
      </div>
...
<CFormInput className="mb-2"
  ...
  />
  ซอย
    <CFormSelect className="mt-2 mb-2">
  <option></option>
